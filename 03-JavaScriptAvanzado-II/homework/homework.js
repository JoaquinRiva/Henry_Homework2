...
function counter() {
  ...
  return function () {
    count++; // Incrementa la variable privada en cada invocación
    return count;
  };
}
...
// Ejemplo de uso
const nuevoContador = counter();
console.log(nuevoContador()); // Salida: 1
console.log(nuevoContador()); // Salida: 2

const otroContador = counter();
console.log(otroContador()); // Salida: 1
console.log(otroContador()); // Salida: 2
